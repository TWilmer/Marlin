...
void GcodeSuite::M122() {
  xyze_bool_t print_axis = {LIST_N(LINEAR_AXES, false, false, false, false, false, false,false,false), false};
  ...
  if (parser.boolval('I')) restore_stepper_drivers();
    ...
    if (parser.seen('V')) {
      tmc_get_registers(
        LIST_N(LINEAR_AXES, print_axis.x, print_axis.y, print_axis.z, print_axis.i, print_axis.j, print_axis.k, print_axis.l, print_axis.m),
        print_axis.e
      );
    }
    else {
