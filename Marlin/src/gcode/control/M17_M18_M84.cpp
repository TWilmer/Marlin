 ...
 */
void GcodeSuite::M17() {
  if (parser.seen(GANG_N(LINEAR_AXES, "X", "Y", "Z", AXIS4_STR, AXIS5_STR, AXIS6_STR, AXIS7_STR, AXIS8_STR) "E")) {
    ...
    #endif
    #if LINEAR_AXES >= 7
      if (parser.seen(AXIS7_STR)) ENABLE_AXIS_L();
    #endif
    #if LINEAR_AXES >= 8
      if (parser.seen(AXIS8_STR)) ENABLE_AXIS_M();
    #endif
