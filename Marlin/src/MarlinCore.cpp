...
PGMSTR(I_STR, AXIS4_STR);     PGMSTR(J_STR, AXIS5_STR);     PGMSTR(K_STR, AXIS6_STR);PGMSTR(L_STR, AXIS7_STR);PGMSTR(M_STR, AXIS8_STR);
PGMSTR(I_LBL, AXIS4_STR ":"); PGMSTR(J_LBL, AXIS5_STR ":"); PGMSTR(K_LBL, AXIS6_STR ":");PGMSTR(L_LBL, AXIS7_STR ":");PGMSTR(M_LBL, AXIS8_STR ":");
PGMSTR(SP_I_STR, " " AXIS4_STR);     PGMSTR(SP_J_STR, " " AXIS5_STR);     PGMSTR(SP_K_STR, " " AXIS6_STR); PGMSTR(SP_L_STR, " " AXIS7_STR); PGMSTR(SP_M_STR, " " AXIS8_STR);
PGMSTR(SP_I_LBL, " " AXIS4_STR ":"); PGMSTR(SP_J_LBL, " " AXIS5_STR ":"); PGMSTR(SP_K_LBL, " " AXIS6_STR ":");PGMSTR(SP_L_LBL, " " AXIS7_STR ":");PGMSTR(SP_M_LBL, " " AXIS8_STR ":");
...
void setup() {
  ...
  #if HAS_TRINAMIC_CONFIG && DISABLED(PSU_DEFAULT_OFF)
    SETUP_RUN(test_tmc_connection(true, LIST_N(LINEAR_AXES, true, true, true, true, true, true, true, true)));
  #endif
